...
namespace EMart.ViewModel.Admin
{
    public class AdminPanalCRUDViewModel
    {
           ...
           // string connection = ConfigurationManager.ConnectionStrings["E_MART"].ConnectionString;
            ...
            if (sdr.HasRows)
            {
                while (sdr.Read())
                {
                    ...
                    pro.CategoryId = int.Parse(sdr["CategoryId"].ToString());
        ...
        public void AddProduct(Products Products)
        {
            ...
            SqlConnection con = new SqlConnection(connection);
            con.Open();
            SqlCommand cmd = new SqlCommand("Sp_Product_ProductExist", con);
            cmd.CommandType = CommandType.StoredProcedure;
            ...
            else
            {
                        ...
                        cmd0.Parameters.AddWithValue("CategoryId", Products.CategoryId);
        ...
        public void AddCategory(Products Products)
        {
...
SqlCommand cmd1 = new SqlCommand("Sp_AddCategory", con);
                ...
                cmd1.Parameters.AddWithValue("CatogoryImage_Path", Products.ProductImage);
        ...
        public Products EditProduct(int id)
        {
            ...
            if(sdr.HasRows)
            {
                ...
                if (sdr.Read())
                {
                   ...
                   pro.CategoryId = int.Parse(sdr["CategoryId"].ToString());
                   pro.CatogoryImage_Path = sdr["CatogoryImage_Path"].ToString();
        ...
        public void AddToCart(int productId, int CustomerId, string CartStatus)
        {
            SqlConnection con = new SqlConnection(connection);
            con.Open();
